...
alias rebuilddwm="cd ~/.config/dwm && sudo make clean install && pkill dwm"
alias rebuildst="cd ~/.config/st && sudo make clean install"
...
function packageScripts () {
  if ! test -f package.json; then
    echo "package.json not found in this pwd ($PWD)"
  else
...
alias tree="exa --icons -la --tree"
alias c="cargo"
alias tmux="tmux-statusline-right && tmux"
